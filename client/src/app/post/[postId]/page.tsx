...
const PostDetails = () => {
  ...
  return (
    <div className="container mx-auto px-5 md:px-48 py-4">
      <div
      ...
      >
        ...
        <div className="flex items-center gap-3 justify-between">
          <h2 className="text-2xl font-bold text-primary-text">{post.title}</h2>
          <button
            onClick={handleGeneratePDF}
            className="flex items-center gap-2 px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition ease-in-out duration-300"
